# Nuave dental-clinic prompt-generation context

> Buyer context: this document generates questions for a dental-clinic client
> audit. Nuave's current buyer is an agency, freelancer, or marketing consultant
> ordering for a client. The dental focus here is a methodology boundary, not
> the current customer definition.

> Status: **Preserved dental-specific prompt context**
>
> Updated: 2026-07-31

## Purpose

This document is the product-knowledge source for generating ten customer
questions for a dental-clinic AI visibility audit or methodology experiment.
It defines what the questions must represent, what inputs may shape them, and
what the generator must never invent.
...
A dental-clinic prompt pack uses:
