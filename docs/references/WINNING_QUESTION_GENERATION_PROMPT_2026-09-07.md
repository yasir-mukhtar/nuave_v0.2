...
- Twelve unnamed candidates are this experiment's output format. Recovering the source does not silently change the product's ten-slot composition, named-question requirements, safety rules, provider configuration, or approved implementation gates.
