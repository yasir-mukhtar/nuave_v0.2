...
> Updated: 2026-09-26 (2026-09-22 founder-settled report amendment; implemented through Spec 012 A/B1/B2; Verified with founder-approved AC-18 exception)
>
...
eight decisions. The spec was approved on 2026-09-22 and implemented through
PRs #74 (A), #80 (B1) and #81 (B2), deployed on 2026-09-26. This amendment
records approved product direction; whole-spec verification is the separate
Spec 012 closeout record. It supersedes the older report order, item limits, excerpt-first presentation,
...
012 B2 own this behavior; B2 implemented it through PR #81.
