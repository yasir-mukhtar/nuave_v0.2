...
function BatasanSection() {
  ...
  return (
    <section id="batasan" className="lp-batasan-section bg-white px-8 py-[120px]">
      <div className="max-w-[1044px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {ITEMS.map((item) => (
            <div key={item.title} className="rounded-[12px] border border-[#E5E7EB] bg-[#F9FAFB] p-8 flex flex-col gap-3">
