...
const ConfirmBusinessPreview = dynamic(() => import("@/components/ConfirmBusinessPreview"), { ssr: false });
const PaymentPreview = dynamic(() => import("@/components/PaymentPreview"), { ssr: false });
const QuestionsPreview = dynamic(() => import("@/components/QuestionsPreview"), { ssr: false });
const ReportPagePreview = dynamic(() => import("@/components/ReportPagePreview"), { ssr: false });
