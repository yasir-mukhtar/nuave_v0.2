...
> **SUPERSEDED — 2026-09-11.** This pre-R5 execution plan is retained only as
> planning history. It is **not** the Spec 008 execution authority and must not
> be implemented from. The sole current implementation authority is
> [`specs/008-recommendation-eligible-question-generation/NUAVE_SPEC_008_IMPLEMENTATION_PLAN_R5.md`](../../specs/008-recommendation-eligible-question-generation/NUAVE_SPEC_008_IMPLEMENTATION_PLAN_R5.md)
> (adopted on branch `docs/spec-008-recommendation-eligible-questions`).

> Status: **Draft** — companion to [`SPEC.md`](../../specs/008-recommendation-eligible-question-generation/SPEC.md), which is also **Draft**.
> Created: 2026-09-07
...
2. [`SPEC.md`](../../specs/008-recommendation-eligible-question-generation/SPEC.md)
3. **this file**
