...
/* ───── Hero Asset URLs ───── */
/* Dashboard mockups are local (public/preview-step-*.png). The AI logos
   below still come from the v1 Framer CDN — no local equivalents exist yet;
   the e2e harness explicitly tolerates framerusercontent.com as a static
   asset CDN. Swap to local SVGs when brand assets are ready. */
...
const AI_LOGOS = [
  {
    src: "https://framerusercontent.com/images/1Qy4nO9eawrvXqYd9ILHfHG5VA.svg",
    alt: "Claude",
    w: 98,
    h: 24,
  },
  {
    src: "https://framerusercontent.com/images/PdwCanOeNG0AbS4iruy4sPRfdas.svg",
    alt: "Gemini",
    w: 110,
    h: 24,
  },
  {
    src: "https://framerusercontent.com/images/qQyt0pI4hotJKK8RE7TMneKyptI.svg",
    alt: "Perplexity",
    w: 94,
    h: 24,
  },
  {
    src: "https://framerusercontent.com/images/5UMspUrrkMvfl7lWs0vuweD8Tyk.svg",
    alt: "Meta AI",
    w: 89,
    h: 24,
  },
  {
    src: "https://framerusercontent.com/images/2WjKGtr45KhKPD7xLIEf4X0qRM.svg",
    alt: "ChatGPT",
    w: 110,
    h: 24,
  },
    ...
    <section className="lp-root lp-hero-section relative w-full pt-[120px] px-[30px] flex justify-center overflow-hidden">
      <div className="max-w-[1200px] w-full flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          {/* CTA Button — fixture entry when enabled, sample link otherwise */}
          {fixturePreviewEnabled ? (
...
function ProblemCard({
  ...
  const handleMouseLeave = useCallback(() => {
    ...
    // Glow stays at last cursor position, ambient drift will gradually take
    // over via lerp
  }, []);
  ...
  return (
    <div className="lp-page min-h-screen bg-white">
      ...
      <div style={{ background: "var(--lp-bg, #f7f7f5)" }}>
        ...
        <HeroSection fixturePreviewEnabled={fixturePreviewEnabled} />
      ...
      {/* ──── Stats (sample-audit anchor target) ──── */}
      <section
        id="sample-audit"
        className="lp-stats-section bg-[#F9FAFB] pt-[120px] pb-[120px] scroll-mt-[100px]"
      >
